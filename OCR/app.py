...
pytesseract.pytesseract.tesseract_cmd = r'C:\Users\ssathiyaseelan\AppData\Local\Programs\Tesseract-OCR\tesseract.exe'
...
DOCUMENT_FOLDER = '/Users/ssathiyaseelan/Desktop/Sakthi/python/OCR/upload'
...
ALLOWED_EXTENSIONS = {'jpg', 'pdf', 'docx', 'xls'}
...
# Helper function to extract text from Image files
def extract_text_from_image(file):
    # Load the image
    image = Image.open(file)
    custom_config = r'--psm 6'  # PSM 6 is optimized for block or table text
